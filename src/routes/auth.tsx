...
function AuthPage() {
  ...
  useEffect(() => {
    ...
    supabase.auth.getSession().then(({ data }) => {
      if (data.session) navigate({ to: afterAuthDestination(), replace: true });
    });
  }, [navigate]);
  ...
  async function signIn(e: React.FormEvent) {
    ...
    navigate({ to: afterAuthDestination(), replace: true });
  }
  ...
  async function google() {
    ...
    else if (!r.redirected) navigate({ to: afterAuthDestination(), replace: true });
  }
